...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <ul style="list-style: none;display: flex">
      <li>
        <div>
            <img src="{{asset('upload/users/'.Auth::user()->img) }}"  style="width: 36px !important;height: 36px !important;" class="avatar avatar-sm me-3" >
        </div>
      </li>
      <li >
        <a href="{{ url('backend/users') }}" class="nav-link text-body font-weight-bold px-0">
          
          <span class="d-sm-inline d-none" style="color:rgb(203,12,159">{{Auth::user()->name }}</span>
        </a>
      </li>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main" style="height:max-content !important">
      <ul class="navbar-nav">
        <!-- Trang chủ -->
        <li class="nav-item">
          <a class="nav-link {{ (Route::is('home')?"active":"")}}" href="{{ url('backend') }}">
        ...
        <!-- Danh mục sản phẩm  -->
        <li class="nav-item">
          <a class="nav-link  {{ (Route::is('categories')?"active":"")}}" href="{{ url('backend/categories') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
         ...
         <!-- Danh sách sản phẩm  -->
         <li class="nav-item">
          <a class="nav-link  {{ (Route::is('products')?"active":"")}}" href="{{ url('backend/products') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
         ...
         <!-- Tin tức -->
         <li class="nav-item">
          <a class="nav-link {{ (Route::is('news')?"active":"")}}" href="{{ url('backend/news') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <!-- Đơn hàng -->
        <li class="nav-item">
          <a class="nav-link  {{ (Route::is('orders')?"active":"")}}" href="{{ url('backend/orders') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>credit-card</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <!-- User -->
        <li class="nav-item">
          <a class="nav-link  {{ (Route::is('users')?"active":"")}}" href="{{ url('backend/users') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <!-- Login -->
        <li class="nav-item">
          <a class="nav-link  login" href="{{ url('backend/login') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <!-- Logout -->
        <li class="nav-item">
          <a class="nav-link  logout" href="{{ url('backend/logout') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">

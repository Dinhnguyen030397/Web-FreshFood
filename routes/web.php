...
})->middleware("check_login")->name("home");

//---
//để sử dụng Controller thì phải khai báo ở đây
use App\Http\Controllers\Admin\UsersController;
//read
Route::get('backend/users',[UsersController::class,'read'])->name("users");
//create
...
//read
Route::get('backend/categories',[CategoriesController::class,'read'])->name("categories");
//create
...
//read
Route::get('backend/products',[ProductsController::class,'read'])->name("products");
//create
...
//read
Route::get('backend/news',[NewsController::class,'read'])->name("news");
//create
...
//read
Route::get('backend/orders',[OrdersController::class,'read'])->name("orders");
//detail
